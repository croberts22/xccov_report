...
class FunctionsTest < ApplicationSystemTestCase
  ...
  test "creating a Function" do
    ...
    fill_in "Covered lines", with: @function.covered_lines
    fill_in "Executable lines", with: @function.executable_lines
    fill_in "Execution count", with: @function.execution_count
    fill_in "Line coverage", with: @function.line_coverage
    fill_in "Line number", with: @function.line_number

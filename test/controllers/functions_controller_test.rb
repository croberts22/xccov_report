...
class FunctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create function" do
    assert_difference('Function.count') do
      post functions_url, params: { function: { covered_lines: @function.covered_lines, executable_lines: @function.executable_lines, execution_count: @function.execution_count, line_coverage: @function.line_coverage, line_number: @function.line_number, name: @function.name } }
    end
  ...
  test "should update function" do
    patch function_url(@function), params: { function: { covered_lines: @function.covered_lines, executable_lines: @function.executable_lines, execution_count: @function.execution_count, line_coverage: @function.line_coverage, line_number: @function.line_number, name: @function.name } }

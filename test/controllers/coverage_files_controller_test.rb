...
class CoverageFilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coverage_file" do
    assert_difference('CoverageFile.count') do
      post coverage_files_url, params: { coverage_file: { covered_lines: @coverage_file.covered_lines, executable_lines: @coverage_file.executable_lines, functions: @coverage_file.functions, line_coverage: @coverage_file.line_coverage, name: @coverage_file.name, path: @coverage_file.path } }
    end
  ...
  test "should update coverage_file" do
    patch coverage_file_url(@coverage_file), params: { coverage_file: { covered_lines: @coverage_file.covered_lines, executable_lines: @coverage_file.executable_lines, functions: @coverage_file.functions, line_coverage: @coverage_file.line_coverage, name: @coverage_file.name, path: @coverage_file.path } }

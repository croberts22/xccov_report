...
class CoverageTargetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coverage_target" do
    assert_difference('CoverageTarget.count') do
      post coverage_targets_url, params: { coverage_target: { build_product_path: @coverage_target.build_product_path, coverage_files: @coverage_target.coverage_files, covered_lines: @coverage_target.covered_lines, executable_lines: @coverage_target.executable_lines, line_coverage: @coverage_target.line_coverage, name: @coverage_target.name } }
    end
  ...
  test "should update coverage_target" do
    patch coverage_target_url(@coverage_target), params: { coverage_target: { build_product_path: @coverage_target.build_product_path, coverage_files: @coverage_target.coverage_files, covered_lines: @coverage_target.covered_lines, executable_lines: @coverage_target.executable_lines, line_coverage: @coverage_target.line_coverage, name: @coverage_target.name } }
